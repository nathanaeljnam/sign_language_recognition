...
from model_alphabet import AlphabetGNN
...
full_alphabet_dataset = np.load("alphabet_dataset/full_alphabet_dataset.npy")
full_alphabet_labels = np.load("alphabet_dataset/full_alphabet_labels.npy")

full_dataset_tensor = torch.tensor(full_alphabet_dataset, dtype=torch.float)
full_labelset_tensor = torch.tensor(full_alphabet_labels, dtype=torch.long)
